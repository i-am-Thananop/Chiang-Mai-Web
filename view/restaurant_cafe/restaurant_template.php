...
<body>
                ...
                <section class="d-flex align-items-center">
                    <div class="container py-4">
                        ...
                        <div class="text-center">
                            <div class="images">
                                <div id="restaurant-images" class="img-size"></div>
                            </div>
                        </div>
                    </div>
                </section>
    ...
    <script>
        ...
        if (restaurant) {
            ...
            document.getElementById('restaurant-transportation').innerHTML = `
                ขนส่งสาธารณะ: ${restaurant.transportation.public}<br>
                การเดินทางโดยรถยนต์: ${restaurant.transportation.private}
            `;
            
            const imagesContainer = document.getElementById('restaurant-images');
            if (imagesContainer && restaurant.images && Array.isArray(restaurant.images)) {
                restaurant.images.slice().reverse().forEach(image => {
