                ...
                <div class="row d-flex justify-content-center align-items-center h-100 py-5">
                    <div class="col-8">
                        <div class="d-flex flex-row">
                            <img src="../../modal/history/t1.jpg" alt="สถานที่เที่ยว 1 ประตูท่าแพ" style="width: 25%; border-radius: 20px;">
                                ...
                                <a href="your-link-here" class="clickable-frame">
                                    <div style="border: 2px solid #000; padding: 10px; border-radius: 10px; width: 400px; background-color: #fff;">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-arrow-right-circle ms-auto" viewBox="0 0 16 16">
